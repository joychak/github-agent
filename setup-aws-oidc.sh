...
set -e
# Configuration
GITHUB_REPO="${GITHUB_REPOSITORY:-joychak/github-agent}"  # Replace with your repo
AWS_REGION="${AWS_REGION:-us-west-2}"
ROLE_NAME="GitHubAgentActionsRole" # Replace for each repository
POLICY_NAME="GitHubAgentActionsPolicy"
